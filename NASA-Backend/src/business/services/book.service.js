...
class BookService {
    ...
    async generateRestockPdf(orderId) {
        try {
            ...
            // .populate('createdBy', 'username'); // Uncomment if createdBy is used
            ...
            // doc.text(`Người tạo: ${order.createdBy ? order.createdBy.username : 'Không xác định'}`); // Uncomment if createdBy is used
            doc.moveDown();
